import codecs
from preprocessing import route
...
class QueryList:
    ...
    def read_query_file(self, file_name=route.training_data_split_file_name):
        # def read_query_file(self, file_name):
        # file_name = "E:\\Lucy\\Dissertation\\code\\model\\QA-System-master\\processed_data\\kbqa.process.data"
